...
class CustomButton extends StatelessWidget {
  ...
  const CustomButton({Key? key, required this.onTap, required this.text, this.isLoading = false, this.backColor, this.textColor, this.loadingColor, required Color color}) : super(key: key);
